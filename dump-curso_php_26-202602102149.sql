...
CREATE TABLE `cidade` (
  ...
  `usuario_altercao` smallint(6) DEFAULT NULL,
  `nome` varchar(255) DEFAULT NULL,
  `codigo_ibge` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cidade_usuario_FK` (`usuario_altercao`),
  CONSTRAINT `cidade_usuario_FK` FOREIGN KEY (`usuario_altercao`) REFERENCES `usuario` (`id`)
...
INSERT INTO `pessoa_fisica` VALUES (1,NULL,NULL,NULL,'1235678','25','2000-11-12','João','1236574883','Maria','M');
...
CREATE TABLE `pessoa_juridica` (
  ...
  `incricao_estadual` varchar(18) NOT NULL,
...
INSERT INTO `usuario` VALUES (1,'Luis','luisfelipesomensi@gmail.com',0,NULL),(2,'Rafael','rafaelmikolaskibelusso@gmail.com',0,NULL),(3,'Henrique Z',NULL,0,NULL),(4,'Ariel',NULL,0,NULL),(5,'Pedro',NULL,0,NULL),(6,'Henrique B',NULL,0,NULL),(12,'Fulano de tal','fulano@gmail.com',0,'0'),(13,'Beltrano de tal','beltrano@gmail.com',0,'0');
...
-- Dump completed on 2026-02-10 21:49:36
